    ...
    const SignUpValidation = (name: string, value: any) => {
        ...
        if (!name && !value) {
            ...
            switch (name) {
                ...
                case 'fname':
                    if (value == '') {
                        //error[name] = "Please enter the first name";
                        setErrorMessage({
                            ...errorMessage,
                ...
                case 'lname':
                    if (value == '') {
                        ...
                        //error[`lname`] = "Please enter only alphabets.";
                        setErrorMessage({
                            ...errorMessage,
                            [name]: 'Please enter only alphabets',
                        });
                ...
                case 'password':
                    if (value == '') {
                        ...
                        //error[`password`] = "Password should be at least greater than 6 character.";
                        setErrorMessage({
                            ...errorMessage,
                ...
                case 'cpassword':
                    if (value == '') {
                        ...
                        //error[`cpassword`] = "Password and confirm password not same.";
                        setErrorMessage({
                            ...errorMessage,
