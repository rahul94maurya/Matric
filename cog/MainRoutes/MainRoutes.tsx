...
const AddEditMatric = React.lazy(() => import("../components/screens/AddEditMatric/AddEditMatric"))
const Report = React.lazy(() => import("../components/screens/Report/Report"))
const PlanEditSprint = React.lazy(() => import("../components/screens/PlanEditSprint/PlanEditSprint"))
const AddEditTickets = React.lazy(() => import("../components/screens/AddEditTickets/AddEditTickets"))
